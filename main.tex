...
\includepdf[page=-]{content/duchuang.pdf}
\includepdf[page=-]{content/blank.pdf}
\includepdf[page=-]{content/shouquan.pdf}
\includepdf[page=-]{content/blank.pdf}
% 正文前页码是大写罗马字母
\pagenumbering{Roman}
% 前言页眉页脚样式 % 摘要
...
\includepdf[page=-]{content/blank.pdf}
\includepdf[page=-]{content/jueyi.pdf}
\end{document}
