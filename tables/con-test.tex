\begin{table*}[tb]
    ...
    \begin{tabularx}{\textwidth}{lccccccccccc}
        ...
        % Ours w/o MBR                                   & \textbf{93.82} & \textbf{93.53} & \textbf{93.67} \\
        % Ours                                             & \textbf{93.84} & \textbf{93.58} & \textbf{93.71} && \textbf{89.18} & \textbf{89.03} & \textbf{89.10} && \textbf{87.66} &         \textbf{87.21}  &         \textbf{87.43}  \\
        Ours                                            & 93.84                    & 93.58                    & 93.71                      &  & 89.18                    & 89.03                    & 89.10                    &  & 87.66          & 87.21          & 87.43          \\

        % \multicolumn{4}{l}{\textbf{Pretrained word embeddings}} \\
        ...
        % \multicolumn{4}{l}{\textbf{ELMo/BERT}} \\
        \hline
        \\[-8pt]
        ...
        %\cite{zhou-zhao-2019-head}                      &         95.70  & \textbf{95.98}  & \textbf{95.84} w/ Large BERT?  &&         -      &         -      &         -      &&         -      &         -      &         -      \\
        % Ours (Max margin) + Pretrained & 94.08 & 93.72 & 93.90 \\
